get_sensor_by_id_responses: dict[int | str, dict[str, object]] = {
	200: {
		...
		'content': {
			'application/json': {
				'example': {'id': '123', 'rooms': ['Room 1'], 'movements': [1], 'is_vertical': True}
			}
		},
	},
	400: {
...
get_sensors_responses: dict[int | str, dict[str, object]] = {
	200: {
		...
		'content': {
			'application/json': {
				'example': [
					{'id': '123', 'rooms': ['Room 1'], 'movements': [1], 'is_vertical': True},
					{'id': '124', 'rooms': ['Room 2'], 'movements': [2], 'is_vertical': True},
				]
			}
		},
	},
